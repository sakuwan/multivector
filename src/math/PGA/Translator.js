 ...
 * portion of a motor. A translator must be normalized, and the scalar component
 * set to 1
 *
 * The TranslatorElement class represents an ideal line, and its provided methods
 ...
 * get / set s:   k-vector component access (3 / s)
 *
 * === Norm operations ===
 *
...
const TRANSLATOR_BASIS = ['e01', 'e02', 'e03', 's'];
createPGAElement(TranslatorElement, formatPGAType(PGATypes.Translator), TRANSLATOR_BASIS);

/* === Translator factory ===
 *
 * (x, y, z, s) -> Translator((x * e01), (y * e02), (z * e03), (s * s))
*/
export const IdealLine = (x = 0, y = 0, z = 0, s = 0) => (
